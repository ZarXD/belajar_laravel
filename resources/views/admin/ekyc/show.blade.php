<x-app-layout>
    <div class="max-w-6x1 mx-auto bg-white p-8 rounded-1g shadow mt-8">
        <h2 class="text-2x1 font-semibold mb-6 border-b pb-3">
        ...
        <section class="mt-8 border-t pt-6">
            <h3 class="text-1g font-semibold mb-4"> Data Pendidikan</h3>
            <div class="space-y-3">
                @foreach ([
        ...
        {{-- Alamat Domisili --}}
        <section class="mt-8 border-t pt-6">
            <h3 class="text-1g font-semibold mb-4"> Alamat Domisili</h3>
            <div class="space-y-3">
                @foreach ([
        ...
        <section class="mt-10 border-t pt-6">
            ...
            <form action="{{ route('admin.ekyc.verify', $data->id) }}" method="POST" class="flex items-center gap-4">
                ...
                <a href="{{ route('admin.ekyc.index') }}" class="text-sm text-gray-600 hover:underline ml-auto"> Kembali </a>
            </form>
        </section>
    </div>
</x-app-layout>