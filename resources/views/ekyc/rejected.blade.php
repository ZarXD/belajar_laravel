<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow mt-8 text-center">
        <h2 class="text-xl font-semibold mb-4 text-gray-700">Verifikasi EKYC Ditolak</h2>
    ...
    <div class="flex flex-col items-center justify-center py-6">
        ...
        <p class="text-gray-700 mb-3 mt-4">
            <strong>Mohon maaf!</strong> Proses registrasi <strong>E-KYC</strong> Anda belum berhasil.
        </p>
        <p class="text-gray-700 mb-6">
            Data Anda <strong>ditolak</strong> setelah proses verifikasi oleh tim kami.<br>
            Hal ini bisa disebabkan oleh foto yang buram, data tidak sesuai, atau dokumen tidak lengkap.
        </p>
        
        <a href="{{ route('ekyc.step1') }}" class="bg-red-600 text-white px-6 py-2 rounded-md hover:bg-red-700 transition">
            Ulangi Proses EKYC
        </a>
    </div>
</div>
